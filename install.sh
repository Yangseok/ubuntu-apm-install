...
sudo apt install -y php php-bz2 php-common php-cli php-curl php-date php-xml php-gd php-gettext php-json php-mbstring php-mysql php-readline php-soap php-sqlite3 php-tokenizer php-xml php-xmlrpc unzip
